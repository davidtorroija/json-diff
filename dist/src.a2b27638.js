...
},{"./bundle-url":"node_modules/parcel/src/builtins/bundle-url.js"}],"src/styles.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel/src/builtins/css-loader.js"}],"src/json-ht.js":[function(require,module,exports) {
"use strict";
...
var _default = BaseFormatter;
exports.default = _default;
},{}],"src/formatter.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.log = exports.format = exports.partitionOps = exports.default = void 0;
...
function (_BaseFormatter) {
  _inherits(JSONFormatter, _BaseFormatter);
  ...
  function JSONFormatter() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(JSONFormatter).call(this));
  ...
  _createClass(JSONFormatter, [{
    key: "prepareContext",
    value: function prepareContext(context) {
      _get(_getPrototypeOf(JSONFormatter.prototype), "prepareContext", this).call(this, context);
      ...
      context.toPath = function (toPath) {
        ...
        return "/".concat(to.join("/"));
      };
    }
  }, {
    key: "typeFormattterErrorFormatter",
    value: function typeFormattterErrorFormatter(context, err) {
      context.out("[ERROR] ".concat(err));
    }
  }, {
    key: "rootBegin",
...
exports.partitionOps = partitionOps;
...
var reorderOps = function reorderOps(diff) {
  var _partitionOps = partitionOps(diff, [isMoveOp, isRemoveOp]),
      _partitionOps2 = _slicedToArray(_partitionOps, 3),
      moveOps = _partitionOps2[0],
      removedOps = _partitionOps2[1],
      restOps = _partitionOps2[2];

  var removeOpsReverse = opsByDescendingOrder(removedOps);
  return [].concat(_toConsumableArray(removeOpsReverse), _toConsumableArray(moveOps), _toConsumableArray(restOps));
};
...
exports.log = log;
},{"./base.js":"src/base.js"}],"src/text-formatter.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(JSONFormatter, [{
    ...
    value: function prepareContext(context) {
      ...
      context.pushCurrentOp = function (obj) {
        ...
        this.result.push("Layer ".concat(this.path[1], ", field \"").concat(this.path[2], "\" ").concat(op, " with \"").concat(value, "\""));
      };
      ...
      context.pushAddOp = function (obj) {
        ...
        this.result.push("Layer ".concat(this.path[1], " added"));
      };
...
exports.log = log;
},{"./base.js":"src/base.js"}],"src/console.js":[function(require,module,exports) {
"use strict";
...
function (_BaseFormatter) {
  ...
  _createClass(ConsoleFormatter, [{
    ...
    value: function typeFormattterErrorFormatter(context, err) {
      ...
      context.out("[ERROR]".concat(err)); //context.popColor();
    }
  }, {
    key: "formatValue",
    ...
    value: function formatTextDiffString(context, value) {
      ...
      for (var i = 0, l = lines.length; i < l; i++) {
        var line = lines[i]; //context.pushColor(colors.textDiffLine);

        context.out("".concat(line.location.line, ",").concat(line.location.chr, " ")); //context.popColor();2

        var pieces = line.pieces;

        for (var pieceIndex = 0, piecesLength = pieces.length; pieceIndex < piecesLength; pieceIndex++) {
          var piece = pieces[pieceIndex]; //context.pushColor(colors[piece.type]);

          context.out(piece.text); //context.popColor();
        }
    ...
    value: function nodeEnd(context, key, leftKey, type, nodeType, isLast) {
      if (type === "node") {
        context.indent(-1);
        context.out(nodeType === "array" ? "]," : "}".concat(isLast ? "" : ","));
      }
...
},{"./base.js":"src/base.js"}],"node_modules/jsondiffpatch/dist/empty.js":[function(require,module,exports) {

},{}],"node_modules/jsondiffpatch/dist/jsondiffpatch.umd.js":[function(require,module,exports) {
var define;
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('./empty')) : typeof define === 'function' && define.amd ? define(['exports', './empty'], factory) : factory(global.jsondiffpatch = {}, global.chalk);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "63591" + '/');
